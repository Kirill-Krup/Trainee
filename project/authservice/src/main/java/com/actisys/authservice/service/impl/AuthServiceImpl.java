...
public class AuthServiceImpl implements AuthService {
  ...
  public JwtResponse register(AuthRequest authRequest) {
    ...
    userCredentials.setRefreshToken(passwordEncoder.encode(refreshToken));
    userCredentialsRepository.save(userCredentials);
  ...
  public JwtResponse login(AuthRequest authRequest) {
    ...
    if(userCredentials.isEmpty() || !passwordEncoder.matches(authRequest.getPassword(), userCredentials.get().getHashedPassword())){
    ...
    uc.setRefreshToken(passwordEncoder.encode(refreshToken));
  ...
  public JwtResponse refreshToken(String refreshToken) {
    ...
    if(userCredentials.getRefreshToken() == null || !passwordEncoder.matches(refreshToken, userCredentials.getRefreshToken())){
      throw new BadCredentialsException("Invalid refresh token");
    }
    ...
    userCredentials.setRefreshToken(passwordEncoder.encode(newRefreshToken));
    userCredentialsRepository.save(userCredentials);
